...
try {
    const injections = require('./map_injection_missed.json');
    ...
    console.log('Successfully injected ' + count + ' missed custom map URLs into quiz_data.js (both web and android-www folders).');
} catch (e) {
