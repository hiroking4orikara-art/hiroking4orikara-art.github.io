...
const keywordMap = {
    ...
    "normalization": ["ノーマライゼーション", "barrier_free"], // wait barrier_free is different
    "barrier_free": ["バリアフリー"],
    ...
    if (section.startsWith('c_') || section.startsWith('cw_')) {
        questions.forEach((q, index) => {
            ...
            if (!hasImg) {
                ...
                // Try literal matching for safety
...
// Re-serialize the full object cleanly, just like apply_civics_batch_10.js does
...
console.log(`Successfully extended map and applied ${replaced} civics images using robust AST parsing!`);
