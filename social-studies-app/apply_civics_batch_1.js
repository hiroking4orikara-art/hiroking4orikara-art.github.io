...
try {
    const batch = JSON.parse(fs.readFileSync('civics_batch_1.json', 'utf8'));
    ...
    batch.forEach(item => {
        ...
        // Find the actual filename created by the AI by checking if the AI file CONTAINS the timestamp
        // or starting prefix, because AI filenames might replace consecutive underscores
    ...
    if (replaced > 0) {
        ...
        console.log(`Successfully applied ${replaced} new images to quiz_data.js!`);
    } else {
