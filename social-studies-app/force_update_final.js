...
const updates = [
  ...
  {
    q: "熊本県北東部にある、世界最大級のカルデラを持つ火山は？", // Actually this asks for mountain (Aso). But I'll use ? mark since the name might reveal it if there is one? Kumamoto has text. Let's cover Kumamoto.
    overlay: makeOverlay([
...
fs.writeFileSync('fix_data_final.js', content, 'utf8');
if (failed.length > 0) {
    console.log("Failed: ", failed);
} else {
    console.log("Success! check fix_data_final.js");
}
